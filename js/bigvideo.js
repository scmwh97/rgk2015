...
;(function($) {
    ...
    $.BigVideo = function(options) {
		...
		function updateSize() {
			...
			var bannerHolder = $(vidEl+'_html5_api').parent().parent().parent();
			var isbannerVideo = bannerHolder.hasClass("big_video") ? true : false;
			
			
			var windowW = isbannerVideo ? bannerHolder.outerWidth() : $(window).width();
			var windowH = isbannerVideo ? bannerHolder.outerHeight() : $(window).height();
			...
			if (windowAspect < mediaAspect) {
				...
				// wider
				var vmcc = $(vidEl+'_html5_api').parent().parent().parent().hasClass("big_video") ? $(vidEl+'_html5_api').parent().parent().parent().outerHeight() : windowH;
				if (currMediaType === 'video') {
					player
						.width(windowW)
						.height(windowW/mediaAspect);
					$(vidEl)
						.css('top',-(windowW/mediaAspect-vmcc)/2)
						.css('left',0)
